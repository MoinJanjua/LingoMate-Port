...
class VoicetotextConverterViewController: UIViewController, UITextFieldDelegate, UIGestureRecognizerDelegate, AVSpeechSynthesizerDelegate {
    
    @IBOutlet weak var Micbtn: UIButton!
    @IBOutlet weak var ToTV: UITextView!
    @IBOutlet weak var FromLanguageTF: DropDown!  // Dropdown for language selection before recording
    ...
    override func viewDidLoad() {
        ...
        FromLanguageTF.isSearchEnable = false
...
//            self.recognitionRequest?.endAudio()
//            self.Micbtn.isEnabled = false
//           // self.Micbtn.setTitle("", for: .normal)
//        } else {
//            self.startRecording()
//            //self.Micbtn.setTitle("", for: .normal)
//        }
//    }
    ...
    @IBAction func translatebtn(_ sender: UIButton) {
        // Check if FromLanguageTF and ToCountryTF dropdowns are selected
        if FromLanguageTF.text?.isEmpty ?? true {
            displayshowAlert(title: "Error", message: "Please select a language for recording.")
            return
        }
...
extension VoicetotextConverterViewController: SFSpeechRecognizerDelegate {
